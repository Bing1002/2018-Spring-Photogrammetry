...
tf.app.flags.DEFINE_string('log_dir', "L:\\Photogrammetry\\Datasets\\FinalProject\\Logs", """ dir to store ckpt """)
tf.app.flags.DEFINE_string('image_dir', "L:\\Photogrammetry\\Datasets\\FinalProject\\train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', "L:\\Photogrammetry\\Datasets\\FinalProject\\test.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "L:\\Photogrammetry\\Datasets\\FinalProject\\val.txt", """ path to CamVid val image """)
tf.app.flags.DEFINE_integer('max_steps', "500", """ max_steps """)
...
tf.app.flags.DEFINE_integer('num_class', "18", """ total class number """)
